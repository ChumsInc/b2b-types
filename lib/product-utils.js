...
function isSellAsSelf(product) {
    return !!product && product.sellAs === product_constants_1.SELL_AS_SELF;
}
exports.isSellAsSelf = isSellAsSelf;
function isSellAsVariants(product) {
    return !!product && product.sellAs === product_constants_1.SELL_AS_VARIANTS;
}
exports.isSellAsVariants = isSellAsVariants;
function isSellAsMix(product) {
    return !!product && product.sellAs === product_constants_1.SELL_AS_MIX;
}
exports.isSellAsMix = isSellAsMix;
function isSellAsColors(product) {
    return !!product && product.sellAs === product_constants_1.SELL_AS_COLORS;
}
