...
## [v2.2.3](https://github.com/ChumsInc/b2b-types/compare/v2.2.2...v2.2.3)

### Commits

- add b2b redux store state types for preloaded state. [`8cdc9b8`](https://github.com/ChumsInc/b2b-types/commit/8cdc9b8ea6bd1d6761b7654b97b37ec34d30bbea)
- stricter exports for package.json [`c316d03`](https://github.com/ChumsInc/b2b-types/commit/c316d031a780c0cc23d76536b6d552bb64d56467)
- feat: update cookie consent types [`fb8701c`](https://github.com/ChumsInc/b2b-types/commit/fb8701cafd749438cfe549b69fbed34f12b2c006)
- feat: update cookie consent types [`587f550`](https://github.com/ChumsInc/b2b-types/commit/587f550f435196a87fdcbf48e7d2b6cece0f7dd5)
- feat: update cookie consent types [`b833b65`](https://github.com/ChumsInc/b2b-types/commit/b833b65d002203ff92d6adc0ebe4b752ce13f860)

## [v2.2.2](https://github.com/ChumsInc/b2b-types/compare/v2.2.1...v2.2.2) - 2025-09-17

### Commits

- feat: add cookie consent types, eslint [`35af846`](https://github.com/ChumsInc/b2b-types/commit/35af8466a1619e2e1660f3a48ef6cd0776cc3019)
- fix: set status on Menu, MenuItem to be boolean instead of boolean|1|0 [`ce959cc`](https://github.com/ChumsInc/b2b-types/commit/ce959ccbbbf58ad7fedabe023cfea5ed9c01e2c3)
- feat: Keyword [`d2f934d`](https://github.com/ChumsInc/b2b-types/commit/d2f934d2a3467c47203cd82e6d5aa6dc544e9886)
- feat: Customer - add ParentDivisionNo, ParentCustomerNo [`c2c0342`](https://github.com/ChumsInc/b2b-types/commit/c2c0342653b74aef76e03fc338deaf1d705fd72e)
- fix: change Message to use standard boolean instead of boolean|number [`e544f2b`](https://github.com/ChumsInc/b2b-types/commit/e544f2b7811016747d6d0835ac51ce9e0abed663)
- fix: set status on Menu, MenuItem to be boolean instead of boolean|1|0 [`1116628`](https://github.com/ChumsInc/b2b-types/commit/11166287ec4c0e77a9d8af9b815a0db978598923)
- feat: Customer - add ParentDivisionNo, ParentCustomerNo [`015bb61`](https://github.com/ChumsInc/b2b-types/commit/015bb614f7ad2b46f5f0036d32e4914e64a2b09f)
- feat: add "requiresLogin" to ContentPage interface [`20c10ec`](https://github.com/ChumsInc/b2b-types/commit/20c10ec1d106e3ff159a68df670179d350a7b054)
- fix: add LastInvoiceNo to SalesOrderHeader [`07154fc`](https://github.com/ChumsInc/b2b-types/commit/07154fc325f14aed1bf8ab8655f0efdb8a5abb53)
- fix: SearchResult pagetype should be specific strings instead of just string; [`25383ba`](https://github.com/ChumsInc/b2b-types/commit/25383ba414c5567818a47865849952e052ce4b8e)
- fix: CustomerUser.accessId should not be optional [`6790e86`](https://github.com/ChumsInc/b2b-types/commit/6790e86e74df8bdfb3dd7e0a49b19e4d641a6bcf)
- fix: add accessId to CustomerUser [`7badb24`](https://github.com/ChumsInc/b2b-types/commit/7badb246d29530a82fa73ecb99c00691efd23ba8)
- feat: add "requiresLogin" to ContentPage interface [`2777cef`](https://github.com/ChumsInc/b2b-types/commit/2777cef21f6b8e4c46b719e10f6f0cbc85b3355a)
- fix: update LayoutWidths to allow string|null [`e0aac43`](https://github.com/ChumsInc/b2b-types/commit/e0aac43bc36d48f964382ed031d8854ed1388bb9)
- feat: add optional newColors for product [`3772210`](https://github.com/ChumsInc/b2b-types/commit/37722102ad632c8a9921fe18d1a2845e193232d7)
- feat: add optional requiresCustomization to CartProduct [`3e4c408`](https://github.com/ChumsInc/b2b-types/commit/3e4c408068e57cc37ea49221212e7c7a1213a17a)
- fix: add DateCreated to SalesOrderHeader [`2a31fdd`](https://github.com/ChumsInc/b2b-types/commit/2a31fdd7347e69be4f7c1bc1d80af17a95e11ff3)
- fix: add accessId to CustomerUser [`34da4cc`](https://github.com/ChumsInc/b2b-types/commit/34da4ccc820ce49d28d41e6bee562bc397c20179)

## [v2.2.1](https://github.com/ChumsInc/b2b-types/compare/v2.2.0...v2.2.1) - 2024-03-22

### Commits

- fix: remove changed property from Customer [`63f8bb5`](https://github.com/ChumsInc/b2b-types/commit/63f8bb5e6523f798d0b255fd5c910af33ec1923e)

## [v2.2.0](https://github.com/ChumsInc/b2b-types/compare/v2.1.8...v2.2.0) - 2024-03-21

### Commits

- test: changing to exports and export files. [`ebe5d2b`](https://github.com/ChumsInc/b2b-types/commit/ebe5d2babc2305ea3271b12ddc8753b69ec5590e)
- fix(Banner): make priority required. [`1707fdb`](https://github.com/ChumsInc/b2b-types/commit/1707fdb442fb4b52e38a20f86320e8a694261246)
- feat: additional attributes and clarifications for BannerImage [`5d30c1c`](https://github.com/ChumsInc/b2b-types/commit/5d30c1c1498cd9cb3e3c10238b9bd5d44c3ca64d)
- feat: additional attributes and clarifications for BannerImage [`0afd348`](https://github.com/ChumsInc/b2b-types/commit/0afd348d793d05a16503e17fbaad82c819becf54)

## [v2.1.8](https://github.com/ChumsInc/b2b-types/compare/v2.1.7...v2.1.8) - 2024-02-27
